...
<div class="widget">
    <div class="widget-extra themed-background-dark">
        ...
        <div class="widget-options">
			<div class="btn-group">
				<?php if($moduleType != 0){  if (strpos($moduleAllowAction, 'MANAGE_GROUP') !== false) { ?>
								...
								<tr id="<?php echo $row->ID_AR; ?>">
									...
									<td class="text-nowrap">
										<fieldset class="rating">
											<input class="PRIORITY_ARTICLE_check" type="radio" id="star5<?php echo $row->ID_AR; ?>" name="rating" value="5" <?php if($row->PRIORITY == "5") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class = "full" for="star5<?php echo $row->ID_AR; ?>" title="Awesome - 5 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" id="star4_5<?php echo $row->ID_AR; ?>" name="rating" value="4.5" <?php if($row->PRIORITY == "4.5") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class="half" for="star4_5<?php echo $row->ID_AR; ?>" title="Pretty good - 4.5 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star4<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="4" <?php if($row->PRIORITY == "4") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class = "full" for="star4<?php echo $row->ID_AR; ?>" title="Pretty good - 4 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star3_5<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="3.5" <?php if($row->PRIORITY == "3.5") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class="half" for="star3_5<?php echo $row->ID_AR; ?>" title="Meh - 3.5 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star3<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="3" <?php if($row->PRIORITY == "3") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class = "full" for="star3<?php echo $row->ID_AR; ?>" title="Meh - 3 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star2_5<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="2.5" <?php if($row->PRIORITY == "2.5") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class="half" for="star2_5<?php echo $row->ID_AR; ?>" title="Kinda bad - 2.5 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star2<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="2" <?php if($row->PRIORITY == "2") echo "checked" ?>  data-iditem="<?php echo $row->ID_AR; ?>" /><label class = "full" for="star2<?php echo $row->ID_AR; ?>" title="Kinda bad - 2 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star1_5<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="1.5" <?php if($row->PRIORITY == "1.5") echo "checked" ?> data-iditem="<?php echo $row->ID_AR; ?>" /><label class="half" for="star1_5<?php echo $row->ID_AR; ?>" title="Meh - 1.5 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star1<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="1" <?php if($row->PRIORITY == "1") echo "checked" ?> data-iditem="<?php echo $row->ID_AR; ?>" /><label class = "full" for="star1<?php echo $row->ID_AR; ?>" title="Sucks big time - 1 star"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star0_5<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="0.5" <?php if($row->PRIORITY == "0.5") echo "checked" ?> data-iditem="<?php echo $row->ID_AR; ?>" /><label class="half" for="star0_5<?php echo $row->ID_AR; ?>" title="Sucks big time - 0.5 stars"></label>
											<input class="PRIORITY_ARTICLE_check" type="radio" type="radio" id="star0<?php echo $row->ID_AR; ?>" name="ratingstar<?php echo $row->ID_AR; ?>" value="0" <?php if($row->PRIORITY == "0") echo "checked" ?> data-iditem="<?php echo $row->ID_AR; ?>" /><label class="None"  <?php if($row->PRIORITY > 0) echo "style=\"display: inline;\"" ?> id="star0<?php echo $row->ID_AR; ?>" for="star0<?php echo $row->ID_AR; ?>" title="None"><i style="font-size: 25px; display: inline-block; margin-top: 4px;margin-right: 5px;" class="text-danger fa fa-times"></i></label>
									...
									<td class="text-nowrap">
										<label class="switch switch-success">
											<input class="IS_SHOW_ARTICLE_check" type="checkbox" <?php if($row->VISIBLE_AR == "1") echo "checked" ?> data-iditem="<?php echo $row->ID_AR; ?>"><span></span>
										</label>
										<div class="divcellsize"></div>
									</td>
									<td class="text-nowrap">
...
<script type="text/javascript">
	$(".IS_SHOW_ARTICLE_check").change(function () {
        var sender = $(this);
