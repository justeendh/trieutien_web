...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		LicenseName = "ckfdjusteendh";
		LicenseKey = "F2KXWY6GQF8FEVEJ3JWNMGWWP8X7CRPL";
		...
		type.Url = BaseUrl + "ImagesUpload/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "ImagesUpload/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Flash" );
		type.Url = BaseUrl + "FlashsUpload/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "FlashsUpload/";
		type.MaxSize = 0;
